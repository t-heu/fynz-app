...
export function FormLancamento({ open, onClose, editandoId }: Props) {
  ...
  useEffect(() => {
    ...
    if (editandoId) {
      ...
      if (!l) return
      setTipo(l.tipo === 'PagamentoFatura' ? 'Despesa' : (l.tipo as 'Despesa' | 'Receita'))
  ...
  return (
    <>
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
            ...
            <View style={{ paddingHorizontal: 16, marginTop: 20 }}>
              <View style={styles.cardFormContainer}>
                ...
                {/* SELEÇÃO ORIGEM / SAIRÁ DE */}
                <TouchableOpacity onPress={() => setOpenDrawer('fonte')} style={styles.formRowItem}>
                  <View style={styles.rowItemLeft}>
                ...
                <View style={[styles.formRowItem, { borderBottomWidth: 0 }]}>
                  <View style={styles.rowItemLeft}>
      ...
      <Modal visible={openDrawer !== null} animationType="slide" transparent={true} onRequestClose={() => setOpenDrawer(null)}>
      ...
      <Modal visible={modalRepeticaoOpen} transparent={true} animationType="fade">
